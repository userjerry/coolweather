...
public class WeatherActivity extends AppCompatActivity {
    ...
    public void requestWeather(String weatherId) {     //源代码加了final
        ...
        HttpUtil.sendOkHttpRequet(weatherUrl, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                final Weather weather = Utility.hangleWeatherRespnse(responseText);
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
    ...
    private void loadBingPic() {
        //访问这个网址，会得到一个图片路径http://cn.bing.com/az/hprichbg/rb/OtterChillin_ZH-CN11488013572_1920x1080.jpg
